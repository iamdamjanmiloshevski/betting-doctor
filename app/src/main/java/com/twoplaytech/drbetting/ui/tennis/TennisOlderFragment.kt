...
*/
@AndroidEntryPoint
class TennisOlderFragment:BaseChildFragment(),Observer<Resource<List<BettingType>>> {
    ...
    override fun initUI() {
        ...
        setUpDataAdapter()
        requestOlderData(Sport.TENNIS)
        viewModel.observeOnOlderTips().observe(viewLifecycleOwner, this)
    }
    companion object{
        fun getInstance():TennisOlderFragment{
            return TennisOlderFragment()
        }
    }
